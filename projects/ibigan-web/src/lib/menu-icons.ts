...
lookup.byTitle.set('Equipamento', Icons.HardHat);
lookup.bySlug.set('equipamento', Icons.HardHat);
...
lookup.bySlug.set('equipamento-estoque', Icons.Package);
lookup.bySlug.set('equipamento-movimentacoes', Icons.Repeat2);
lookup.bySlug.set('equipamento-manutencao', Icons.Wrench);
lookup.bySlug.set('equipamento-baixados', Icons.Archive);
